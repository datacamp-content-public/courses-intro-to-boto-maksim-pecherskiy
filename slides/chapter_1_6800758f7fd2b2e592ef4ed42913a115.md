...
Then we create a reference to the object we will create. We create a new instance of an object, passing bucket name and key as arguments. 

--

This does not mean there is an object in the bucket yet. It's just a reference, and right now it points to an empty space.

Next, let's fill that empty space with the contents of our trout_obs.csv. We call the object instance's upload_file method, and pass the local file name as an argument.  
