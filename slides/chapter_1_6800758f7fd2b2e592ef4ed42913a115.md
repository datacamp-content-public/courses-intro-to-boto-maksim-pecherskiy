...
First create your resource by calling the the boto3 resource method with the argument 's3'.

--

Then, create a new instance of an object, passing bucket name and key as arguments. 
